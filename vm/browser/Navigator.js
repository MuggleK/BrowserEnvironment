...
navigator.__proto__["userActivation"] = userActivation;
...
navigator.__proto__["connection"]['rtt'] = 50;
...
navigator.__proto__["javaEnabled"] = function javaEnabled(){debugger; return false;};   safefunction(navigator.__proto__["javaEnabled"]);
...
navigator.__proto__["userAgentData"] = {
    brands: [
        {
            brand: " Not;A Brand",
            version: "99"
...
navigator.__proto__["plugins"]['namedItem'] = {name: 'namedItem'};
navigator.__proto__["plugins"]['refresh'] = {name: 'refresh'};
navigator.__proto__["plugins"]['item'] = {name: 'item'};
